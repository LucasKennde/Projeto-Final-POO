...
const aluno2 = new Aluno('Juliana', 'Guimaraes', 'Juliana@gmail.com', 'presencial', turmaPresencial, new Date(1996,12,5), [10, 10, 10,10], true,"B" )

console.log(aluno1.Idade())
turmaPresencial.adicionarAluno(aluno1)
console.log(turmaPresencial)

console.log(Aluno.alunosRegistrados)