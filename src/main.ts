...
const infinitySchool = new Escola('Infinity School');
...
infinitySchool.adicionarTurma(turmaPresencial)

aluno1.nome = 'teste'

console.log(aluno12.idade);
...
console.log(infinitySchool.listarTurmas())
